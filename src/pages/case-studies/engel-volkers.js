    ...
    <EasyLayout title="Engel & Völkers Case Study" location={location}>
      <section id="case-study" className="bg-white">
        ...
        <div className="container">
          ...
          <p>As the main developer of the synchronization services between the legacy and the new infrastructures, I faced many issues due to the nature of the legacy systems (i.e., dozens of different protocols, drivers, and APIs). Testing new code changes meant either waiting for a new deployment or manually setting up port-forwarding, SSH tunnels, and SSH proxies.</p>
          ...
          <p>The average time required for testing and debugging was dramatically reduced. The overall complexity for the development of services has decreased and we no longer need to maintain docker-compose files for local development.</p>
          ...
          <div className="text-center">
            <a href="/docs/latest" className="btn btn-black">Get Started</a>
          </div>
        </div>
